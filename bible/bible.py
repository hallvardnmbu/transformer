"""Bible text generation wrapper model for the Transformer backend."""
...
class Bible(torch.nn.Module):
    ...
    def __init__(self, config=Hyperparameters()):
        ...
        config : Hyperparameters, optional
            Configuration parameters for the Bible class. Default is Hyperparameters().
        """
        super().__init__()
